...
class DinsosBelumTile extends StatefulWidget {
  const DinsosBelumTile({
    Key? key,
  }) : super(key: key);

  @override
  State<DinsosBelumTile> createState() => _BelumTileState();
}

class _BelumTileState extends State<DinsosBelumTile> {
  String belum = '';
  String dati2 = '';
