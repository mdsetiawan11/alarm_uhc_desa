...
class GantiPasswordDinkes extends StatefulWidget {
  const GantiPasswordDinkes({super.key});

  @override
  State<GantiPasswordDinkes> createState() => _GantiPasswordState();
}

class _GantiPasswordState extends State<GantiPasswordDinkes> {
