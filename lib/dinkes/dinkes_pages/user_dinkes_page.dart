...
import 'package:loginapp/dinkes/dinkes_pages/ganti_pw_dinkes.dart';
import 'package:loginapp/shared/colors.dart';
import 'package:shared_preferences/shared_preferences.dart';

class UserDinkesPage extends StatefulWidget {
  const UserDinkesPage({super.key});

  @override
  State<UserDinkesPage> createState() => _UserDinkesPageState();
}

class _UserDinkesPageState extends State<UserDinkesPage> {
  String nama = '';
                    ...
                    child: MaterialButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const GantiPasswordDinkes()));
                      },
                      child: ListTile(
                        leading: Icon(
                          Icons.password,
